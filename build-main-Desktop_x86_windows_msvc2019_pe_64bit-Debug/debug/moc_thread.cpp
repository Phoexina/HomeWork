...
void ScanThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ScanThread::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScanThread::send)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ScanThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScanThread::log)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ScanThread::send(QString _t1, QString _t2)
{
...
// SIGNAL 1
void ScanThread::log(QString _t1)
{
...
void SendThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SendThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendThread::log)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SendThread::log(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
